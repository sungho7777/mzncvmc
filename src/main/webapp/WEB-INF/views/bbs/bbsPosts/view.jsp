        ...
        <div class="page-header-content">
            <div class="row align-items-center justify-content-between pt-3">
                ...
                <div class="col-12 col-xl-auto mb-3">
                    <a id="btnGoList" class="btn btn-sm btn-light text-primary" href="#" onclick="main.goList('bbs/bbsPosts', null);">
    ...
    <div class="row gx-4">
        ...
        <div class="col-lg-2">
            <div class="card card-header-actions">
                ...
                <div class="card-body">
                    <div class="d-grid">
                        <button id="btnGoAmend" class="fw-500 btn btn-warning" onclick="main.goAmend('bbs/bbsPosts', null, ${id}, 'PUT');">Amend</button>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    const renderTable = (data) => {
        ...
        $("#btnGoAmend").attr("onclick", "main.goAmend('bbs/bbsPosts', "+data.categoryId+", " +data.postId+ ", 'PUT');");
    };
</script>