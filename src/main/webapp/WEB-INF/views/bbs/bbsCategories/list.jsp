            ...
            <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
                ...
                <div class="datatable-container">
                    <table id="datatablesSimple" class="datatable-table">
                        <thead>
                        <tr>
                            <th style="width: 54%;">Post Title</th>
                        ...
                        <tbody id="grid" />
                        <tr>
                            <td colspan="5" class="text-center">The data you searched for does not exist.</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
...
<script type="text/javascript">
    ...
    const init = () => {
        ...
        $("#page-header-title").text("Bbs Categories");
        $("#goAmendBtn").text("Add New Bbs Categories");
    ...
    const renderGrid = (data, tbodyId) => {
        ...
        if (!data || data.length === 0) {
            ...
            tr.innerHTML = `<td colspan="5" class="text-center">The data you searched for does not exist.</td>`;
        ...
        data.forEach((item, index) => {
            ...
            tr.innerHTML = [
                ...
                '<td>' + item.isActive + '</td>',
                '<td>' + item.readPermission + ', ' + item.writePermission + '</td>',

                '<td class="text-center">' + board.createActionButtons(item.categoryId, null) + '</td>'
            ].join('');
